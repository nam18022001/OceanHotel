                    ...
                    <div class="row">
                        <div class="col-xl-3 col-sm-6 widget-inline-box">
                            <div class="text-center p-3">
                                ...
                                <p class="text-muted mb-0">Khách hàng đặt phòng</p>
                            </div>
                        </div>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <img src="{{asset('admin_assets/assets/images/users/avatar-2.jpg')}}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm">
                                </td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <img src="{{asset('admin_assets/assets/images/users/avatar-1.jpg')}}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm">
                                </td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <img src="{{asset('admin_assets/assets/images/users/avatar-3.jpg')}}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm">
                                </td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <img src="{{asset('admin_assets/assets/images/users/avatar-4.jpg')}}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm">
                                </td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <img src="{{asset('admin_assets/assets/images/users/avatar-5.jpg')}}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm">
                                </td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <img src="{{asset('admin_assets/assets/images/users/avatar-6.jpg')}}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm">
                                </td>
