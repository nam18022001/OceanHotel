                ...
                <div class="col-lg-12">
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="{{asset('page_assets/images/team-1.png')}}" alt="alternative">
                        </div>
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="{{asset('page_assets/images/team-2.png')}}" alt="alternative">
                        </div>
                        <!-- end of image wrapper -->
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="{{asset('page_assets/images/team-3.png')}}" alt="alternative">
                        </div>
                        <!-- end of image wrapper -->
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="{{asset('page_assets/images/team-4.png')}}" alt="alternative">
                        </div>
                        <!-- end of image wrapper -->
