 ...
 <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link page-scroll" href="#intro">Phòng VIP</a>
            </li>
            <li class="nav-item">
                <a class="nav-link page-scroll" href="#services">Đặt phòng</a>
            </li>
            <li class="nav-item">
                <a class="nav-link page-scroll" href="#callMe">Liên hệ</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle page-scroll" href="#about" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">Giới thiệu</a>
